...
"winpos 5 5          " 设定窗口位置  
set lines=140 columns=185    " 设定窗口大小  
...
func SetTitle() 
	...
	if &filetype == 'sh' 
		...
		call append(line(".")+1, "\# Author: zhuyisong") 
		call append(line(".")+2, "\# mail: zhuyisong1994@gmail.com") 
...
func! CompileRunGcc()
	exec "w"
	if &filetype == 'c'
		exec "!gcc -Wall -g % -o main"
		exec "! ./main"
	elseif &filetype == 'cpp'
		exec "!g++ -Wall -g % -o main"
		exec "! ./main"
